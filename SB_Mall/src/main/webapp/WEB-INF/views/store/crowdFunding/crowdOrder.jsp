	...
	$(document).ready(function(){
		...
		$('.doFunding').on('click',function(){
			...
			if(agree==3){
				...
				console.log(
				"crOrderDetailNo : "+typeof crOrderDetailNo,
				"userSeq : "+typeof userSeq,
				"finalPrice : "+typeof finalPrice,
				"cardNo : "+typeof cardNo,
				"cardPassword : "+typeof cardPassword,
				"birthNo : "+typeof birthNo,
				"zipCode : "+typeof zipCode,
				"orderAddress : "+typeof orderAddress,
				"orderPhone : "+typeof orderPhone,
				"orderRequest : "+typeof orderRequest,
				"orderName : "+typeof orderName
				);
				
				
				var detailForm = 
					'<input type="hidden" name="orderDetail.crOrderDetailNo" value="'+crOrderDetailNo+'">'
					+'<input type="hidden" name="orderDetail.userSeq" value="'+userSeq+'">'
					+'<input type="hidden" name="orderDetail.finalPrice" value="'+finalPrice+'">'
				...
				$('.orderBag').each(function(index){
					var crOrderDetailNoFK = crOrderDetailNo;
					...
					var orderAppend = 
						'<input type="hidden" name="orderList['+bagCnt+'].crOrderDetailNo" value="'+crOrderDetailNoFK+'">'
...
<div class="orderSuperBox">
	...
	<c:forEach var="orderList" items="${orderList.orders}">
		...
		<div class="finalPriceBox ib">
			...
			<h1 class="finalPriceF ib"><fmt:formatNumber value="${finalPrice}" pattern="#,###"/></h1>
			<h3 class="finalPriceWon ib">원</h3>
			
			<h3 class="hidden finalPrice">${finalPrice}</h3>
		</div>
